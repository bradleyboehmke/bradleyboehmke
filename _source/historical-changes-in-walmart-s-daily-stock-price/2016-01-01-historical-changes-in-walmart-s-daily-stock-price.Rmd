...
<a href="http://bradleyboehmke.github.io/2015/12/scraping-html-text.html"><img src="http://3dprint.com/wp-content/uploads/2014/05/wal-1.jpg" alt="Walmart" style="float:left; margin:0px 8px 0px 0px; width: 17%; height: 17%;"></a>
...
```{r, fig.width=8, fig.height=4, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
library(dplyr)
library(dygraphs)
