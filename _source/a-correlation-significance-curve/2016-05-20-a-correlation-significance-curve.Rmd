...
<a href="http://bradleyboehmke.github.io"><img src="correlation.png" alt="Significance of Correlation" style="float:left; margin: 0px 5px -5px 0px; width: 15%; height: 15%;"></a>
...
http://bradleyboehmke.github.io/figure/source/a-correlation-significance-curve/2016-05-20-a-correlation-significance-curve/correlation_comparison.png
...
p <- ggplot(df, aes(`Sample size (n)`, `Absolute correlation (r)`)) +
        ...
        annotate("text", x = 513, y = 0.650, label = "produce statistically significant results at p < 0.05.", color = "forestgreen") +
