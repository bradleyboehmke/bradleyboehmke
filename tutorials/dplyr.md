...
There are seven fundamental functions of data transformation that the dplyr package provides:
...
`dplyr` is a one such package which was built for the sole purpose of simplifying the process of manipulating, sorting, summarizing, and joining data frames.
<br>
